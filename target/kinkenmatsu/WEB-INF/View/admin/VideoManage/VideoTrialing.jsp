...
<div class="container" style="width: 100%;height: auto">
    <div class="row">
        <div class="col-sm-12" style="background: white;width:auto;height: 300px;">
            <div class="row">
                <c:forEach items="${UnTrialVideos}" var="c" >
                    <div class="card" style="width: 15%;height: auto;margin: 10px;border: 0px solid">
                        ...
                        <div class="row">
                            <a class="Arhover layui-icon layui-icon-ok" style="text-decoration-line: none;" href="${pageContext.request.contextPath}/IsTrialed.do?id=${c.id}">审核通过</a>
                            <a class="Arhover layui-icon layui-icon-delete" style="text-decoration-line: none;" href="${pageContext.request.contextPath}/ToDeleteVideo.do?id=${c.id}">删除</a>
                        </div>
                    </div>
                </c:forEach>
            </div>
